...
function @GetMoveForwardBackward($Alias:text) : number
	return input_number($Alias, 1)
	
function @GetMoveLeftRight($Alias:text) : number
	return input_number($Alias, 2)
	
function @GetMoveUpDown($Alias:text) : number
	return input_number($Alias, 3)
	
function @GetPitch($Alias:text) : number
	return input_number($Alias, 4)
	
function @GetRoll($Alias:text) : number
	return input_number($Alias, 5)
	
function @GetYaw($Alias:text) : number
	return input_number($Alias, 6)
	
function @GetMainThrust($Alias:text) : number
